...
void initCANMREX(gpio_num_t TX_GPIO_NUM, gpio_num_t RX_GPIO_NUM, uint8_t nodeID) {
    ...
    //  uint32_t alerts_to_enable = TWAI_ALERT_RX_QUEUE_FULL | TWAI_ALERT_TX_IDLE |
    //  TWAI_ALERT_BUS_ERROR; if (twai_reconfigure_alerts(alerts_to_enable, NULL) == ESP_OK) {
